...
const HeaderHome = () => {
  ...
  return (
    <div className="relative xs:h-[90vh]  z-50">
      <video
        autoPlay
        loop
        muted
      ...
      <div
        ...
        absolute bottom-0 left-0 w-full grid justify-center 
            ...
            <div className="relative p-4 w-full max-w-2xl max-h-full">
              <div className="relative shadow">
                <div className="md:p-5 p-[20px] bg-[#D9D9D9] rounded-[10px]">
                  ...
                  <p className="md:text-[18px] md:leading-[30px] text-[13px] leading-[20px] mb-[27px]">
                    more ticket options including student concession are
                    available. please call +91 8420460550
                  </p>
