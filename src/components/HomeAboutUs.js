...
const HomeAboutUs = () => {
  return (
    <div className=" bg-white font-helvetica xs:mx-[32px]">
      <div className="flex flex-col lg:flex-row-reverse justify-center lg:gap-[92px] lg:mt-[150px] xs:mt-[60px]">
      <div className="lg:w-1/2">
        ...
        <p
          className=" font-normal font-helvetica xs:text-[12px] xs:leading-[18px] xs:pb-[25px] lg:text-[16px]
        "
        >
